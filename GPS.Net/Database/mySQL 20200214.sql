...
CREATE TABLE `tbl_accesscontrol_list` (
  ...
  `AdvtechController` int(11) DEFAULT NULL,
...
INSERT INTO `tbl_accesscontrol_list` VALUES (1,'Admin',1,1,1,1,1,1,1,1,1),(2,'Engineer',1,1,1,1,1,1,1,1,1),(3,'Technician',1,1,1,1,0,1,1,1,1),(4,'Operator',1,0,1,1,0,1,1,1,1);
...
-- Dump completed on 2020-02-14 14:24:50
